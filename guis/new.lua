...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/Yodaveey/98KA/main/'..select(1, path:gsub('newvape/', ''))..'?t='..tostring(math.random(1, 99999999)), true)
		end)
...
getcustomasset = function(path)
	...
	return not inputService.TouchEnabled and assetfunction and downloadFile(path, assetfunction) or ''
end
...
function mainapi:CreateGUI()
	...
	discordbutton.MouseButton1Click:Connect(function()
		...
		task.spawn(function()
			tooltip.Text = 'Copied!'
			setclipboard('https://discord.gg/95NXrDVqut')
		end)
	end)
...
scarcitybanner.Text = 'Join 98KA server to report any bugs, suggestions or buy prem, click discord icon :D'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Yodaveey/98KA/main/loader.lua', true))()
		end
	end,
